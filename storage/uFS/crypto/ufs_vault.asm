; =============================================================================
; Tattva OS — ufs/crypto/ufs_vault.asm
; =============================================================================
; Encrypted Vault Key Manager (Argon2id + AES-KWP).
;
; Derives disk key encryption keys from user passphrases using Argon2id and
; wraps master volume keys using AES Key Wrap with Padding (RFC 5649).
;
