...
;   - Real-time quota tracking updates (`ufs_quota_charge`, `ufs_quota_uncharge`)
;
...
global ufs_quota_charge
global ufs_quota_uncharge
...
;
; Inputs:
;   RDI = Pointer to ufs_quota_t structure
...
ufs_quota_check_alloc:
    ...
    mov rax, [rbx + ufs_quota_t.current_inodes]
    add rax, rdx
    cmp rax, [rbx + ufs_quota_t.hard_limit_inodes]
    jg .edquot_exceeded
...
ufs_quota_charge:
    ...
    mov rbx, rdi
    add [rbx + ufs_quota_t.current_bytes], rsi
    add [rbx + ufs_quota_t.current_inodes], rdx
...
ufs_quota_uncharge:
    ...
    mov rbx, rdi
    sub [rbx + ufs_quota_t.current_bytes], rsi
    sub [rbx + ufs_quota_t.current_inodes], rdx
