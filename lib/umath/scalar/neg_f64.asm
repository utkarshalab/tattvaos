%ifndef GUARD_LIB_UMATH_SCALAR_NEG_F64_ASM
%define GUARD_LIB_UMATH_SCALAR_NEG_F64_ASM
; =============================================================================
...
section .rodata
align 16
negf64_sign_mask:      dq 0x8000000000000000, 0x8000000000000000
...
umath_neg_f64:
    movsd   xmm1, [rel negf64_sign_mask]
...
umath_neg_f64_array:
    ...
    movups  xmm15, [rel negf64_sign_mask]
...
%endif ; GUARD_LIB_UMATH_SCALAR_NEG_F64_ASM
