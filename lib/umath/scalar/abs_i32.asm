...
align 16
const_int32_min:    dd 0x80000000, 0x80000000, 0x80000000, 0x80000000
const_int32_max:    dd 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF
...
umath_abs_i32_sat_array:
    ...
    movups  xmm14, [rel const_int32_min]
    movups  xmm15, [rel const_int32_max]
...
.loop_unrolled:
    ...
    movups  xmm8, [rel const_int32_max]
    movups  xmm9, [rel const_int32_max]
    movups  xmm10, [rel const_int32_max]
    movups  xmm11, [rel const_int32_max]
