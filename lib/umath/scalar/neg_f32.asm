%ifndef GUARD_LIB_UMATH_SCALAR_NEG_F32_ASM
%define GUARD_LIB_UMATH_SCALAR_NEG_F32_ASM
; =============================================================================
...
section .rodata
align 16
negf32_sign_mask:      dd 0x80000000, 0x80000000, 0x80000000, 0x80000000
...
umath_neg_f32:
    movss   xmm1, [rel negf32_sign_mask]
...
umath_neg_f32_array:
    ...
    movups  xmm15, [rel negf32_sign_mask]
...
%endif ; GUARD_LIB_UMATH_SCALAR_NEG_F32_ASM
