...
section .rodata
align 16
const_one_f32:      dd 1.0, 1.0, 1.0, 1.0
const_neg_one_f32:  dd -1.0, -1.0, -1.0, -1.0
const_zero_f32:     dd 0.0, 0.0, 0.0, 0.0
...
umath_sign_f32:
    ...
    ; Positive path
    movss   xmm0, [rel const_one_f32]
    ret

.negative:
    movss   xmm0, [rel const_neg_one_f32]
.done:
    ret
...
umath_sign_f32_array:
    ...
    movups  xmm12, [rel const_one_f32]
    movups  xmm13, [rel const_neg_one_f32]
