...
section .rodata
align 16
const_one_f64:      dq 1.0, 1.0
const_neg_one_f64:  dq -1.0, -1.0
const_zero_f64:     dq 0.0, 0.0
...
umath_sign_f64:
    ...
    ; Positive path
    movsd   xmm0, [rel const_one_f64]
    ret

.negative:
    movsd   xmm0, [rel const_neg_one_f64]
.done:
    ret
...
umath_sign_f64_array:
    ...
    movups  xmm12, [rel const_one_f64]
    movups  xmm13, [rel const_neg_one_f64]
