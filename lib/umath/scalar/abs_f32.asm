%ifndef GUARD_LIB_UMATH_SCALAR_ABS_F32_ASM
%define GUARD_LIB_UMATH_SCALAR_ABS_F32_ASM
; =============================================================================
...
%endif ; GUARD_LIB_UMATH_SCALAR_ABS_F32_ASM
